...
public function list_user($user_id)
	{
		...
		$size = $this->purchase_orders_model->count_purchase_orders_search($category_name, $category_description, $client_description, $user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->purchase_orders_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description, $client_description);
