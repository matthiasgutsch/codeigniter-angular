...
public function timesheets_by_project($id, $user_id)
	{
		...
		$size = $this->timesheets_model->count_timesheets_by_project_search($category_name, $category_description, $user_id, $id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->timesheets_model->get_timesheets_by_project($id, $user_id, $_start, $_limit, $_sort, $category_name, $category_description);
...
public function timesheets_by_employee($id, $user_id)
	{
		...
		$size = $this->timesheets_model->count_timesheets_by_employee_search($category_name, $category_description, $project_id, $user_id, $id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->timesheets_model->get_timesheets_by_employee($id, $user_id, $_start, $_limit, $_sort, $category_name, $category_description, $project_id);
...
public function list_user($user_id)
	{
		...
		$size = $this->timesheets_model->count_timesheets_search($category_name, $category_description, $employee, $type, $project_id, $user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->timesheets_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description, $employee, $type, $project_id);
