...
class Tags extends CI_Controller {
	...
	public function index()
	{
		...
		$categories = $this->tags_model->get_tags_public();
...
public function list_user($user_id)
	{
		...
		$size = $this->tags_model->count_tags($category_name, $category_description,$user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->tags_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
	...
	public function user($user_id)
	{
		...
		$categories = $this->tags_model->get_tags($user_id);
	...
	public function id($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$category = $this->tags_model->get_id($id);
	...
	public function create($user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$id = $this->tags_model->create($categoryData);
	...
	public function update($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$this->tags_model->update($id, $categoryData);
	...
	public function delete($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$blog = $this->tags_model->get_id($id);
