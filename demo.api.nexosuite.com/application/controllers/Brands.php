...
class Brands extends CI_Controller {
	...
	public function index()
	{
		...
		$posts = array();
				$categories = $this->brand_model->get_brands();
...
public function list_user($user_id)
	{
		...
		$size = $this->brand_model->count_brands($category_name, $category_description,$user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->brand_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
	...
	public function user($user_id)
	{
		...
		$posts = array();
		if($isValidToken) {
				$categories = $this->brand_model->get_brands($user_id);
	...
	public function id($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$category = $this->brand_model->get_id($id);
	...
	public function create($user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$id = $this->brand_model->create($categoryData);
	...
	public function update($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$this->brand_model->update($id, $categoryData);
	...
	public function delete($id)
	{
		...
		if($isValidToken) {
			...
			$blog = $this->brand_model->get_id($id);
