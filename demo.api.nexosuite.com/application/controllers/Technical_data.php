...
class Technical_data extends CI_Controller {

		public function __construct()
	{
		parent::__construct();
		$this->load->model('technical_data_model');
	...
	public function index()
	{
		...
		$posts = array();
				$categories = $this->technical_data_model->get_technical_data_public();
...
public function list_user($user_id)
	{
		...
		$size = $this->technical_data_model->count_technical_data($category_name, $category_description,$user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->technical_data_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
...
public function user($user_id)
	{
		...
		$posts = array();
		if($isValidToken) {
				$categories = $this->technical_data_model->get_technical_data($user_id);
	...
	public function id($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$category = $this->technical_data_model->get_id($id);
	...
	public function create($user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$id = $this->technical_data_model->create($categoryData);
	...
	public function update($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$this->technical_data_model->update($id, $categoryData);
	...
	public function delete($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$blog = $this->technical_data_model->get_id($id);


			$this->technical_data_model->delete($id);
