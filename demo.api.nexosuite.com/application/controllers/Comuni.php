...
class Comuni extends CI_Controller {
	...
	public function categories()
	{
		...
		$categories = $this->comuni_model->get_comuni();
	...
	public function index()
	{
		...
		$isValidToken = $this->comuni_model->checkToken($token);
	...
	public function id($id)
	{
		...
		if($isValidToken) {
			...
			$post = array(
				...
				'category_region' => $category->category_region,
	...
	public function updateCategory($id)
	{
		...
		if($isValidToken) {
			...
			$category_name = $this->input->post('category_name');
			$category_region = $this->input->post('category_region');
			$category_address = $this->input->post('category_address');
			$category_description = $this->input->post('category_description');
