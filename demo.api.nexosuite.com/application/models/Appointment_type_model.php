...
public function get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description)
	{
			...
			$this->db->like('appointment_type.category_name', $category_name);
			$this->db->like('appointment_type.category_description', $category_description);
	...
	public function count_appointment_type($category_name=NULL, $category_description=NULL, $user_id)
	{
	$this->db->select('*');
	$this->db->from('appointment_type');
	$this->db->where('appointment_type.user_id', $user_id);
