...
import { PARAM_CHECKINS_PATH, PARAM_CHECKOUTS_PATH, PARAM_WORKS_PATH, STATUS_PRODUCTS } from '../../../constants/constants';
...
@Component({
  ...
  templateUrl: './manage-warehouses-checkouts.component.html'
})
export class ManageWarehousesCheckoutsComponent implements OnInit {
  blogs: Blog;
  blog: Blog;
