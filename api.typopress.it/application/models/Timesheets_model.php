...
public function get_timesheets_by_project($id, $user_id)
	{
...
public function get_timesheets_by_employee($id, $user_id, $_start, $_limit, $_sort, $category_name, $category_description)
	{
...
public function get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description, $employee)
	{
...
public function count_timesheets_by_employee_search($category_name=NULL, $category_description=NULL, $user_id, $id)
	{
	$this->db->select('*');
	$this->db->from('timesheets');
	$this->db->where('timesheets.user_id', $user_id);
...
public function count_timesheets_search($category_name=NULL, $category_description=NULL, $employee=NULL, $user_id)
	{
	$this->db->select('*');
	$this->db->from('timesheets');
	$this->db->where('timesheets.user_id', $user_id);
