...
class Clients extends CI_Controller {
	...
	public function count($id)
	{
		...
		$token = $this->input->get_request_header('Authorization');
			...
			$posts = $this->clients_model->count_clients($id);
	...
	public function index()
	{
		...
		$posts = array();
		if($isValidToken) {
			$blogs = $this->clients_model->get_clients();
...
public function list_user($user_id)
	{
		...
		$size = $this->clients_model->count_clients_search($category_name, $category_description, $user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->clients_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
	...
	public function user($id)
	{
		...
		$posts = array();
		if($isValidToken) {
			$blogs = $this->clients_model->get_clients_user($id);
			foreach($blogs as $blog) {
				$posts[] = array(
					'id' => $blog->id,
					'name' => $blog->name,
...
public function skills($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$blog = $this->clients_model->get_id($id);
...
public function search()
	{
		...
		header("Access-Control-Allow-Headers: authorization, Content-Type");
			...
			$blog = $this->clients_model->search($id);
...
public function create($user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$id = $this->clients_model->create($blogData);
	...
	public function update($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$this->clients_model->update($id, $blogData);
