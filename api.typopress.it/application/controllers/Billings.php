...
public function list_user($user_id)
	{
		...
		$size = $this->billings_model->count_billings_search($category_name, $category_description, $user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->billings_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
