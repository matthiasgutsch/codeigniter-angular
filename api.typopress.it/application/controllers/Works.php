...
class Works extends CI_Controller {
	...
	public function index()
	{
		...
		$categories = $this->works_model->get_works();
...
public function list_user($user_id)
	{
		...
		$size = $this->works_model->count_works($category_name, $category_description,$user_id);
		...
		$isValidToken = $this->api_model->checkToken($token, $user_id);
			...
			$blogs = $this->works_model->get_list($user_id, $_start, $_limit, $_sort, $category_name, $category_description);
	...
	public function user($user_id)
	{
		...
		$categories = $this->works_model->get_works($user_id);
	...
	public function id($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			$category = $this->works_model->get_id($id);
	...
	public function create($user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$id = $this->works_model->create($categoryData);
	...
	public function update($id, $user_id)
	{
		...
		if($isValidToken) {
			...
			if( ! $isUploadError) {
				...
				$this->works_model->update($id, $categoryData);
	...
	public function delete($id,$user_id)
	{
		...
		if($isValidToken) {
			...
			$blog = $this->works_model->get_id($id);
